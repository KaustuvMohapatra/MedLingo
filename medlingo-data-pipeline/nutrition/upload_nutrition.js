...
const fileName = 'medlingo_nutrition_db.json';
...
async function uploadNutritionData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Nutrition questions...`);
  ...
  console.log("\n🎉 NUTRITION UPLOAD COMPLETE! Krause, Shils, and Gropper are now in your database.");
}
