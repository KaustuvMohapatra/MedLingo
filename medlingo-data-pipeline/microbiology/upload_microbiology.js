...
const fileName = 'medlingo_microbiology_db.json';

async function uploadMicrobiologyData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Microbiology questions...`);
  ...
  console.log("\n🎉 MICROBIOLOGY UPLOAD COMPLETE! Jawetz, Murray's, and Gladwin are now in your database.");
}

uploadMicrobiologyData();