...
const fileName = 'medlingo_physiology_db.json';

async function uploadPhysiologyData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Physiology questions...`);
  ...
  console.log("\n🎉 PHYSIOLOGY UPLOAD COMPLETE! Guyton, Costanzo, and Ganong's are now in your database.");
}

uploadPhysiologyData();