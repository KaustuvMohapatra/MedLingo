...
const fileName = 'medlingo_internal_medicine_db.json';

async function uploadInternalMedData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Internal Medicine questions...`);
  ...
  console.log("\n🎉 INTERNAL MEDICINE UPLOAD COMPLETE! Harrison's, Goldman-Cecil, and Step-Up are now in your database.");
}

uploadInternalMedData();