...
const fileName = 'medlingo_psychiatry_db.json';

async function uploadPsychiatryData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Psychiatry questions...`);
  ...
  console.log("\n🎉 PSYCHIATRY UPLOAD COMPLETE! Kaplan & Sadock's, DSM-5-TR, and First Aid are now in your database.");
}

uploadPsychiatryData();