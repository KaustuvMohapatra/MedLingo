...
const fileName = 'medlingo_clinical_medicine_db.json';

async function uploadClinicalData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Clinical questions...`);
  ...
  console.log("\n🎉 CLINICAL MEDICINE UPLOAD COMPLETE! Macleod's, Bates', and Hutchison's are now in your database.");
}
