...
const fileName = 'medlingo_anatomy_db.json';

async function uploadAnatomyData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Anatomy questions...`);
  ...
  console.log("\n🎉 ANATOMY UPLOAD COMPLETE! Gray's, Moore's, and Netter's are now in your database.");
}
