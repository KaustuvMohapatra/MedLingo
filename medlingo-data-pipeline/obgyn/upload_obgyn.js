...
const fileName = 'medlingo_obgyn_db.json';

async function uploadOBGYNData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE OBGYN questions...`);
  ...
  console.log("\n🎉 OBGYN UPLOAD COMPLETE! Williams, Hacker & Moore's, and Blueprints are now in your database.");
}
