...
const fileName = 'medlingo_pathology_db.json';

async function uploadPathologyData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Pathology questions...`);
  ...
  console.log("\n🎉 PATHOLOGY UPLOAD COMPLETE! Robbins, Pathoma, and Goljan are now in your database.");
}
