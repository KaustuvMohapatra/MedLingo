...
const fileName = 'medlingo_pharmacology_db.json';

async function uploadPharmacologyData() {
  ...
  console.log(`🚀 Starting upload of ${uniqueQuestions.length} UNIQUE Pharmacology questions...`);
  ...
  console.log("\n🎉 PHARMACOLOGY UPLOAD COMPLETE! Katzung, Goodman & Gilman's, and Lippincott are now in your database.");
}

uploadPharmacologyData();